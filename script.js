...
const songs = [
  {
    title: "Sweet",
    src: "music/Sweet - Cigarettes After Sex(MP3_160K).mp3"
  },
  {
    title: "Ivy",
    src: "music/Frank Ocean - Ivy(MP3_160K).mp3"
  },
  {
    title: "Lisboa",
    src: "music/ANAVITÓRIA_ LENINE  - LISBOA(MP3_160K).mp3"
  },
  {
    title: "Sparks",
    src: "music/Coldplay - Sparks(MP3_160K).mp3"
  },
  {
    title: "No. 1 Party Anthem",
    src: "music/No. 1 Party Anthem(MP3_160K).mp3"
  },
];
